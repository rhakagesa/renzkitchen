...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>Ren'z Kitchen | Ubud's Best Gluten-Free Treats</title>
        ...
        <link href="landing-page/lib/flaticon/font/flaticon.css" rel="stylesheet">
        <link href="landing-page/lib/tempusdominus/css/tempusdominus-bootstrap-4.min.css" rel="stylesheet" />
    ...
    <body>
        ...
        <div class="navbar nav-sticky navbar-expand-lg bg-light navbar-light">
            <div class="container-fluid">
                <a href="index.html" class="navbar-brand"><img src="landing-page/img/logo-renzkitchen.png" alt="logo"></a>
                ...
                <div class="owl-carousel">
                    <div class="carousel-item">
                        <div class="carousel-img">
                            <img src="landing-page/img/carousel-1.jpg" alt="Image">
                        </div>
                        <div class="carousel-text">
                            <h1>Ubud's Best <span>Gluten-Free</span> Treats</h1>
                            <p>
                                Welcome to Ren'z Kitchen, where we specialize in delicious gluten-free treats that are perfect for everyone.     
                            </p>
                    ...
                    <div class="carousel-item">
                        <div class="carousel-img">
                            <img src="landing-page/img/carousel-2.jpg" alt="Image">
                        </div>
                        <div class="carousel-text">
                            <h1>Healthy & <span>Delicious</span> Dishes</h1>
                            <p>
                                Our menu features a variety of dishes made with the finest ingredients, ensuring that you enjoy every bite without compromising on taste or health.
                            </p>
                            <div class="carousel-btn">
                                <a class="btn custom-btn" href="">View Menu</a>
                                <a class="btn custom-btn" href="">Book Table</a>
                    ...
                    <div class="carousel-item">
                        <div class="carousel-img">
                            <img src="landing-page/img/carousel-3.jpg" alt="Image">
                        </div>
                        <div class="carousel-text">
        ...
        <div class="about">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        <div class="about-img">
                            <img src="landing-page/img/about.jpg" alt="Image">
                    ...
                    <div class="col-lg-5">
                        ...
                        <div class="feature-text">
                            <div class="feature-img">
                                <div class="row">
                                    <div class="col-6">
                                        <img src="landing-page/img/feature-1.jpg" alt="Image">
                                    </div>
                                    <div class="col-6">
                                        <img src="landing-page/img/feature-2.jpg" alt="Image">
                                    </div>
                                    <div class="col-6">
                                        <img src="landing-page/img/feature-3.jpg" alt="Image">
                                    </div>
                                    <div class="col-6">
                                        <img src="landing-page/img/feature-4.jpg" alt="Image">
                                    </div>
                                </div>
                            </div>
                            <p>
                        ...
                        <div id="burgers" class="container tab-pane active">
                            <div class="row">
                                <div class="col-lg-7 col-md-12">
                                    <div class="menu-item">
                                        <div class="menu-img">
                                            <img src="landing-page/img/menu-burger.jpg" alt="Image">
                                        </div>
                                        <div class="menu-text">
                                ...
                                <div class="col-lg-5 d-none d-lg-block">
                                    <img src="landing-page/img/menu-burger-img.jpg" alt="Image">
                                </div>
                            </div>
                        </div>
                        <div id="snacks" class="container tab-pane fade">
                            <div class="row">
                                <div class="col-lg-7 col-md-12">
                                    <div class="menu-item">
                                        <div class="menu-img">
                                            <img src="landing-page/img/menu-snack.jpg" alt="Image">
                                        </div>
                                        <div class="menu-text">
                                ...
                                <div class="col-lg-5 d-none d-lg-block">
                                    <img src="landing-page/img/menu-snack-img.jpg" alt="Image">
                                </div>
                            </div>
                        </div>
                        <div id="beverages" class="container tab-pane fade">
                            <div class="row">
                                <div class="col-lg-7 col-md-12">
                                    <div class="menu-item">
                                        <div class="menu-img">
                                            <img src="landing-page/img/menu-beverage.jpg" alt="Image">
                                        </div>
                                        <div class="menu-text">
                                ...
                                <div class="col-lg-5 d-none d-lg-block">
                                    <img src="landing-page/img/menu-beverage-img.jpg" alt="Image">
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6">
                        <div class="team-item">
                            <div class="team-img">
                                <img src="landing-page/img/team-1.jpg" alt="Image">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="team-item">
                            <div class="team-img">
                                <img src="landing-page/img/team-2.jpg" alt="Image">
                                <div class="team-social">
                                    <a href=""><i class="fab fa-twitter"></i></a>
                                    <a href=""><i class="fab fa-facebook-f"></i></a>
                                    <a href=""><i class="fab fa-linkedin-in"></i></a>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="team-item">
                            <div class="team-img">
                                <img src="landing-page/img/team-3.jpg" alt="Image">
                                <div class="team-social">
                                    <a href=""><i class="fab fa-twitter"></i></a>
                                    <a href=""><i class="fab fa-facebook-f"></i></a>
                                    <a href=""><i class="fab fa-linkedin-in"></i></a>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="team-item">
                            <div class="team-img">
                                <img src="landing-page/img/team-4.jpg" alt="Image">
                                <div class="team-social">
                                    <a href=""><i class="fab fa-twitter"></i></a>
                                    <a href=""><i class="fab fa-facebook-f"></i></a>
                                    <a href=""><i class="fab fa-linkedin-in"></i></a>
                ...
                <div class="owl-carousel testimonials-carousel">
                    <div class="testimonial-item">
                        <div class="testimonial-img">
                            <img src="landing-page/img/testimonial-1.jpg" alt="Image">
                        </div>
                        <p>
                    ...
                    <div class="testimonial-item">
                        <div class="testimonial-img">
                            <img src="landing-page/img/testimonial-2.jpg" alt="Image">
                        </div>
                        <p>
                            Lorem ipsum dolor sit amet elit. Phasel nec preti mi. Curabit facilis ornare velit non vulput
                        </p>
                    ...
                    <div class="testimonial-item">
                        <div class="testimonial-img">
                            <img src="landing-page/img/testimonial-3.jpg" alt="Image">
                        </div>
                        <p>
                            Lorem ipsum dolor sit amet elit. Phasel nec preti mi. Curabit facilis ornare velit non vulput
                        </p>
                    ...
                    <div class="testimonial-item">
                        <div class="testimonial-img">
                            <img src="landing-page/img/testimonial-4.jpg" alt="Image">
                        </div>
                        <p>
                            Lorem ipsum dolor sit amet elit. Phasel nec preti mi. Curabit facilis ornare velit non vulput
                        </p>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="blog-item">
                            <div class="blog-img">
                                <img src="landing-page/img/blog-1.jpg" alt="Blog">
                            </div>
                    ...
                    <div class="col-md-6">
                        <div class="blog-item">
                            <div class="blog-img">
                                <img src="landing-page/img/blog-2.jpg" alt="Blog">
                            </div>
                            <div class="blog-content">
                                <h2 class="blog-title">Lorem ipsum dolor sit amet</h2>
                                <div class="blog-meta">
        ...
        <script src="landing-page/lib/tempusdominus/js/moment.min.js"></script>
        <script src="landing-page/lib/tempusdominus/js/moment-timezone.min.js"></script>
        <script src="landing-page/lib/tempusdominus/js/tempusdominus-bootstrap-4.min.js"></script>
        
        <!-- Contact Javascript File -->
        <script src="landing-page/mail/jqBootstrapValidation.min.js"></script>
        <script src="landing-page/mail/contact.js"></script>
